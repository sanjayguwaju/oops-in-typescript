 ...
 */
class ColoredPrinter extends GenericPrinter {
  /**
...
const printerArray: GenericPrinter[] = [new GenericPrinter(), new ColoredPrinter()];
...
printerArray.forEach((printer) => printer.print("MyDoc"));
